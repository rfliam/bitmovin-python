...
from bitmovin import Bitmovin, Encoding, HTTPSInput, \
    ...
    H265CodecConfiguration, StartEncodingRequest, VodDashStartManifest, VodHlsStartManifest
...
def main():
    ...
    startRequest = StartEncodingRequest(vod_dash_manifests=[VodDashStartManifest(dash_manifest.id)],
                                        vod_hls_manifests=[VodHlsStartManifest(hls_manifest.id)])
